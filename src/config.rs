...
pub struct Config {
    ...
    /// Canonical mesh origin for the separately bound admin listener's OIDC callback.
...
impl Config {
    ...
    pub fn from_env() -> Self {
        Self {
            ...
            public_url: env_or("PUBLIC_URL", "http://127.0.0.1:3130")
                .trim_end_matches('/')
                .to_string(),
            admin_url: env_or("ADMIN_URL", "http://127.0.0.1:3131")
                .trim_end_matches('/')
                .to_string(),
    ...
    pub fn for_tests() -> Self {
        Self {
            ...
            admin_url: "http://127.0.0.1:3131".into(),
