...
export function BuyButton({ seller, offer, version, operationKey }: { seller: string; offer: string; version: number; operationKey: string }) {
  return <Command action={requestInvoice} label="Request invoice"><OperationKey value={operationKey}/><input type="hidden" name="seller" value={seller}/><input type="hidden" name="offer" value={offer}/><input type="hidden" name="version" value={version}/></Command>;
}
...
export function ConfirmReceiptButton({ claim, claimVersion, orderVersion, operationKey }: { claim: string; claimVersion: number; orderVersion: number; operationKey: string }) {
  return <Command action={confirmReceipt} label="Confirm receipt"><OperationKey value={operationKey}/><input type="hidden" name="claim" value={claim}/><input type="hidden" name="claimVersion" value={claimVersion}/><input type="hidden" name="version" value={orderVersion}/><label>Source<input name="externalNamespace" defaultValue="manual" required/></label><label>Receipt ID<input name="externalId" required/></label></Command>;
}
