                  ...
                  <td>
                    {row.sides.map((side) => (
                      <div key={side.publicId}>
                        <Link href={`/platform/parties/${side.personPublicId}`}>{side.name}</Link>{' '}
                        <span className="note">
            ...
            <tbody>
              {merges.map((row) => (
                <tr key={row.auditId}>
                  ...
                  <td>
                    <Link href={`/platform/parties/${row.survivor.publicId}`}>
                      {row.survivor.name}
                    </Link>
                  </td>
                  <td>
                    <Link href={`/platform/parties/${row.absorbed.publicId}`}>
                      {row.absorbed.name}
                    </Link>
                  </td>
                  <td>{row.method}</td>
