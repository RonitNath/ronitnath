...
const expected = generateGithubWorkflow({ packageVersion: '0.1.1', runnerLabels: ['self-hosted', 'ronitnath-delivery', 'delenda'], pipelineFile: 'delivery.pipeline.json', nodeVersion: '24.13.0', pnpmVersion: '10.28.1' })
