...
forbidden:  You may not argue from build cost, from simplicity, or from "add it when we need it".
...
Write valid YAML to exactly this path:
    ...
    /Users/ronitnath/dev/portfolio/products/voice/debates/DEBATE-001-lenses/out/archivist.yaml
