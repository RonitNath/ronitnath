...
success:    The hot path does the minimum; measurement never blocks it and never perturbs what it
            measures.
forbidden:  You may not argue from "we would lose visibility", nor from the owner's evaluation
            needs.
...
Write valid YAML to exactly this path:
    ...
    /Users/ronitnath/dev/portfolio/products/voice/debates/DEBATE-001-lenses/out/realtime.yaml
