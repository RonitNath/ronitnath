...
5. **UX artifacts** — human-visible surfaces get Penpot work structured per `design-gate.md` (base screen, gallery, flows, breakpoints — prototyped, linked tokens), linked by packet ID; follow `procedures/design.md`. Reviewed at the design gate.
